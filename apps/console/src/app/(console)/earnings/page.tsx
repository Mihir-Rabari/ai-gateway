...
export default function EarningsPage() {
  ...
  const { debits, credits, estimatedEarnings, pending } = useMemo(() => {
    // ⚡ Bolt: Combines multiple filter/reduce passes into a single reduce over the dataset.
    // Reduces O(3N) time complexity to O(N) and eliminates intermediate array allocations.
