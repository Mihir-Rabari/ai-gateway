...
export default function AppsPage() {
  ...
  return (
    <div className="space-y-6">
      <ShellSection eyebrow="Apps" title="Application inventory" description="Manage registered applications, redirect URIs, and issued credentials from one table." action={<Link href="/apps/new"><Button><Plus className="h-4 w-4" />Register app</Button></Link>} />
