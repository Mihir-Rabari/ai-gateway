...
export default function AppsPage() {
  ...
  return (
    <div className="space-y-6">
      <ShellSection eyebrow="Apps" title="Application inventory" description="Manage registered applications, redirect URIs, and issued credentials from one table." action={<Link href="/apps/new" className="inline-flex h-11 items-center justify-center gap-2 rounded-full px-5 text-sm font-medium transition duration-200 disabled:cursor-not-allowed disabled:opacity-55 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 bg-white text-black hover:bg-white/86"><Plus className="h-4 w-4" />Register app</Link>} />
