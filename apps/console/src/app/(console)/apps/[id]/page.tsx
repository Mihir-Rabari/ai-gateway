              ...
              <div className="mt-3 flex items-center justify-between gap-3 bg-black border border-zinc-800 rounded px-3 py-2 font-mono text-sm text-white">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <button
                    ...
                    disabled={!apiKey}
                    className="text-zinc-400 hover:text-white disabled:opacity-30 transition p-1 hover:bg-zinc-900 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
                    title="Copy API Key"
