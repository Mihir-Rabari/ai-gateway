              ...
              <div className="mt-3 flex items-center justify-between gap-3 bg-black border border-white/10 rounded px-3 py-2 font-mono text-sm text-white">
                ...
                <div className="flex items-center gap-1.5">
                  <button
                    ...
                    title={!apiKey ? "Rotate key to generate a visible API key to view" : (showKey ? "Hide API Key" : "Show API Key")}
                    aria-label={!apiKey ? "Rotate key to generate a visible API key to view" : (showKey ? "Hide API Key" : "Show API Key")}
                  >
