...
export default function AppDetailsPage() {
  ...
  return (
    <div className="space-y-6">
      <ShellSection eyebrow="App detail" title={appData?.name ?? "Application detail"} description="Inspect credentials, edit redirect URIs, and review analytics for this app." action={<Link href="/apps" className="inline-flex h-11 items-center justify-center gap-2 rounded-full px-5 text-sm font-medium transition duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 border border-white/10 bg-white/8 text-white hover:bg-white/14">Back to apps</Link>} />
