...
export default function DashboardPage() {
  ...
  // ⚡ Bolt: Combine filter and reduce into a single pass over the array
  // This reduces time complexity from O(2N) to O(N) and prevents intermediate array allocation.
