    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-6 font-sans">
      <Card className="w-full max-w-sm bg-[#0a0a0a] border-white/10 text-white">
        <CardHeader className="text-center space-y-2">
          ...
          <CardTitle className="text-2xl font-bold tracking-tight">Developer Console</CardTitle>
          <CardDescription className="text-white/60">
            Sign in to build apps with AI Gateway
          </CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardFooter className="flex flex-col space-y-4 border-t border-white/5 mx-6 pt-6 px-0 pb-6">
          ...
          <a
            ...
            className="text-xs text-center text-white/40 hover:text-white/80 transition-colors flex items-center justify-center"
          >
            ← Back to AI Gateway
          </a>
        </CardFooter>
