...
>(function Button({ className, variant = "primary", busy, children, disabled, ...props }, ref) {
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex h-11 items-center justify-center gap-2 rounded-full px-5 text-sm font-medium transition duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 disabled:cursor-not-allowed disabled:opacity-55",
        palette,
        className,
      )}
      {...props}
  ...
  function TextInput({ className, ...props }, ref) {
    return (
      <input
        ref={ref}
        className={cn(
          "h-12 w-full rounded-2xl border border-white/10 bg-white/[0.03] px-4 text-sm text-white placeholder:text-white/28 outline-none transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 focus:border-white/20 focus:bg-white/[0.05]",
          className,
        )}
        {...props}
      />
  ...
  function TextArea({ className, ...props }, ref) {
    return (
      <textarea
        ref={ref}
        className={cn(
          "min-h-[132px] w-full rounded-[22px] border border-white/10 bg-white/[0.03] px-4 py-3 text-sm text-white placeholder:text-white/28 outline-none transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 focus:border-white/20 focus:bg-white/[0.05]",
          className,
        )}
        {...props}
      />
