      ...
      {toasts.map((toast) => (
        ...
        >
          ...
          <button
            ...
            className="mt-3 text-xs uppercase tracking-[0.22em] text-white/38 transition hover:text-white/72 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 rounded"
          >
            Dismiss
          </button>
        </div>
