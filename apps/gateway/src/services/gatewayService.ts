...
export class GatewayService {
  ...
  async processRequest(input: {
    ...
    // ⚡ Bolt: Atomic rate limit increment and expire via Lua script.
    // Replaces sequential incr/expire, preventing un-expiring keys if process crashes between commands.
