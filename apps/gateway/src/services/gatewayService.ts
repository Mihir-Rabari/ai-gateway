...
// ⚡ Bolt: Replace sequential INCR/EXPIRE with atomic Lua script to prevent un-expiring keys
// in case the application crashes between INCR and EXPIRE commands.
