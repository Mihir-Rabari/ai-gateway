...
import { createLogger, getFastifyLoggerOptions, ok, fail, GatewayError, securityHeadersPlugin } from '@ai-gateway/utils';
...
app.get(
  ...
  async (req: FastifyRequest<{ Querystring: { userId: string } }>, reply: FastifyReply) => {
    ...
    // ⚡ Bolt: Batch json parsing to avoid sequential stream reading bottleneck
