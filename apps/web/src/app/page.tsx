...
const features = [
  {
    ...
    description:
      "Route OpenAI, Anthropic, Google, and Codex through one stable API. Switch providers without changing your code.",
    tag: "01 / LAYER",
  },
  {
    icon: Zap,
    ...
    description:
      "Auto-select the best model and provider path based on performance, cost, and budget goals. Failover in under 120ms.",
    tag: "02 / PERFORMANCE",
  },
  {
    icon: CreditCard,
    ...
    description:
      "Built-in credits, usage tracking, and per-request metering. Monetize AI from day one — no external billing stack.",
    tag: "03 / BILLING",
  },
  {
    icon: Shield,
    ...
    description:
      "Request policies, rate limits, audit logs, and failover controls. Production-grade governance without extra tooling.",
    tag: "04 / COMPLIANCE",
  },
];
...
const steps = [
  {
    ...
    title: "Create an app",
    description:
      "Sign up, create a developer app, and get your API key in under a minute.",
  },
  {
    num: "02",
    title: "Call one endpoint",
    description:
      "Send requests to our unified API. Switch models with a single parameter — no code changes.",
  },
  {
    num: "03",
    title: "Track & scale",
    description:
      "Monitor usage, costs, and latency in real time. Scale across providers with confidence.",
  },
];
  ...
  return (
    <div className="relative min-h-screen bg-[#09090b] text-zinc-100 antialiased selection:bg-zinc-800 selection:text-white">
      ...
      <nav className="sticky top-0 z-50 border-b border-zinc-800/50 bg-[#09090b]/80 backdrop-blur-xl">
        <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6 lg:px-8">
          <div className="flex items-center gap-3">
            ...
            <p className="text-sm font-mono tracking-tight font-bold text-zinc-50">
              AI Gateway
            </p>
          </div>
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/login"
              className="hidden text-xs font-mono uppercase tracking-wider text-zinc-400 transition-colors hover:text-zinc-100 sm:block"
            >
              Sign in
            </Link>
            <Button
              asChild
              size="sm"
              className="rounded-md bg-zinc-50 text-zinc-950 hover:bg-zinc-200 font-mono text-xs uppercase tracking-wider h-8 btn-glow"
            >
      ...
      <main className="relative z-10">
          ...
          <div className="grid items-center gap-12 lg:grid-cols-12">
            ...
            <div className="lg:col-span-7 flex flex-col items-start animate-slide-up">
              ...
              <p className="mt-6 max-w-2xl text-base leading-relaxed text-zinc-400 md:text-lg">
                One API, one wallet, one dashboard. Route LLM requests across
                OpenAI, Anthropic, Gemini, and Codex with performance-optimized
                failover, credit enforcement, and live auditing.
              </p>
              <div className="mt-8 flex flex-wrap items-center gap-3">
                <Button
                  asChild
                  size="lg"
                  className="h-11 rounded-md bg-zinc-50 px-6 font-mono text-xs uppercase tracking-wider text-zinc-950 hover:bg-zinc-200"
                >
                  <Link href="/signup">
                ...
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="h-11 rounded-md border-zinc-800 bg-transparent hover:bg-zinc-900 px-6 font-mono text-xs uppercase tracking-wider text-zinc-300"
                >
                  <a
                ...
                <div className="p-5 text-xs leading-relaxed">
                  ...
                  <div className="pl-4">
                    <span className="text-emerald-400">
                      &quot;https://api.your-gateway.com/v1/chat&quot;
                    </span>
                    <span className="text-zinc-500">,</span>
                  </div>
                  ...
                  <div className="mt-4 border-t border-zinc-800 pt-4">
                    <div className="text-zinc-500">
                      {"// ↳ Auto-routed to cheapest provider"}
                    </div>
                    <div className="mt-1">
                      <span className="text-zinc-300">model</span>
                      <span className="text-zinc-500">:</span>{" "}
                      ...
                      <span className="text-zinc-600">{"// via OpenAI"}</span>
                    </div>
                    <div className="mt-1">
                    ...
                    <div className="mt-1">
                      ...
                      <span className="text-zinc-500">:</span>{" "}
                      <span className="text-amber-400">842</span>
        ...
        <section
          id="features"
          className="container mx-auto px-4 py-16 md:px-6 md:py-24 lg:px-8 border-t border-zinc-900"
        >
          <div className="mb-12 max-w-3xl">
            ...
            <p className="mt-4 text-zinc-400 text-base md:text-lg">
              Everything teams need to move from prototype to production without
              rewriting infrastructure every quarter.
            </p>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {features.map((f) => (
              <div
                key={f.title}
                className="border border-zinc-800 bg-[#0c0c0e] rounded-lg p-6 md:p-8"
              >
        ...
        >
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-zinc-400">
              One setup flow, clear metrics, and billing that scales with
              customer usage.
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {steps.map((s) => (
              <div
                key={s.num}
                className="border border-zinc-800 bg-[#0c0c0e] rounded-lg p-6"
              >
                <span className="font-mono text-2xl text-zinc-700 block mb-4">
                  {s.num}
                </span>
          ...
          <div className="border border-zinc-800 bg-[#0c0c0e] rounded-lg p-8 md:p-12 flex flex-col md:flex-row md:items-center md:justify-between gap-8">
            <div>
              ...
              <p className="mt-2 max-w-xl text-zinc-400 text-sm">
                Integrate in minutes, then scale traffic with confidence using
            ...
            <div className="flex flex-wrap gap-3">
              <Button
                asChild
                size="lg"
                className="rounded-md bg-zinc-50 text-zinc-950 hover:bg-zinc-200 font-mono text-xs uppercase tracking-wider h-11 px-6"
              >
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="rounded-md border-zinc-800 bg-transparent hover:bg-zinc-900 text-zinc-300 font-mono text-xs uppercase tracking-wider h-11 px-6"
              >
