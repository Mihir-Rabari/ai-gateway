          ...
          <div className="grid items-center gap-10 lg:grid-cols-12">
            <div className="lg:col-span-7">
              ...
              <div className="animate-slide-up-delay-2 mt-8 flex flex-wrap items-center gap-3">
                <Button size="lg" className="group rounded-full bg-slate-950 px-7 text-white hover:bg-slate-800" asChild>
                  <Link href="/signup">
                    Build with AI Gateway
                    <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
                  </Link>
                </Button>
                <Button size="lg" variant="outline" className="rounded-full border-slate-900/20 bg-white/80 px-7" asChild>
          ...
          <Card className="border-slate-900/10 bg-gradient-to-r from-cyan-500 to-emerald-500 text-white shadow-2xl shadow-cyan-900/20">
            <CardContent className="flex flex-col items-start justify-between gap-6 p-8 md:flex-row md:items-center md:p-10">
              ...
              <div className="flex flex-wrap gap-3">
                <Button size="lg" className="rounded-full bg-white text-slate-950 hover:bg-white/90" asChild>
                  <Link href="/signup">
                    Create account
                  </Link>
                </Button>
                <Button size="lg" variant="outline" className="rounded-full border-white/60 bg-transparent text-white hover:bg-white/10" asChild>
        ...
        <div className="container mx-auto flex flex-col items-center justify-between gap-4 px-4 py-9 text-sm text-slate-600 md:flex-row md:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-5">
            ...
            <a
              ...
              className="transition-colors hover:text-slate-950 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
              target="_blank"
