              ...
              <div className="border border-zinc-800 bg-[#0c0c0e] rounded-lg overflow-hidden font-mono glass-card">
                ...
                <div className="p-5 text-xs leading-relaxed">
                  ...
                  <div className="mt-4 border-t border-zinc-800 pt-4">
                    ...
                    <div className="mt-1">
                      <span className="text-zinc-300">latency</span><span className="text-zinc-500">:</span> <span className="text-amber-400">231</span><span className="text-zinc-300">ms</span> <span className="text-zinc-600">{`// cached`}</span>
                    </div>
                  </div>
                </div>
              </div>
